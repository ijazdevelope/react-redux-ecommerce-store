...
const ProductComponent = () => {
    ...
    // const renderProducts = products?.map(list => {
    //     const { id, category, description, image, title } = list;

    //     return (
    //         <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4" key={id}>
    //             <div class="flex flex-col items-center justify-center w-full max-w-lg mx-auto">
    //                 <img class="object-cover w-full rounded-md h-72 xl:h-80" src={image} alt={title} />
    //                 <h4 class="mt-2 text-lg font-medium text-gray-700 dark:text-gray-200">{id}</h4>
                        ...
                        <div class="mt-6 lg:mt-0 lg:px-2 lg:w-4/5 ">
                            ...
                            <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                {products.map(product => {
                                    ...
                                    return (
                                        <div class="flex flex-col items-center justify-center w-full max-w-lg mx-auto" key={id}>
                                            <img class="object-cover w-full rounded-md h-72 xl:h-80" src={image} alt={title} />
                                            <h4 class="mt-2 text-lg font-medium text-gray-700 dark:text-gray-200">{id}</h4>
                                            <p class="text-blue-500">$12.55</p>
